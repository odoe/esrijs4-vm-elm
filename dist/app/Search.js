...
Elm.Search.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var item = Elm.Native.Port.make(_elm).inboundSignal("item",
   "Search.Model",
   function (v) {
      return typeof v === "object" && "value" in v && "placeholder" in v && "suggestions" in v && "selectedValue" in v ? {_: {}
                                                                                                                         ,value: typeof v.value === "string" || typeof v.value === "object" && v.value instanceof String ? v.value : _U.badPort("a string",
                                                                                                                         v.value)
                                                                                                                         ,placeholder: typeof v.placeholder === "string" || typeof v.placeholder === "object" && v.placeholder instanceof String ? v.placeholder : _U.badPort("a string",
                                                                                                                         v.placeholder)
                                                                                                                         ,suggestions: typeof v.suggestions === "object" && v.suggestions instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.suggestions.map(function (v) {
                                                                                                                            return typeof v === "string" || typeof v === "object" && v instanceof String ? v : _U.badPort("a string",
                                                                                                                            v);
                                                                                                                         })) : _U.badPort("an array",
                                                                                                                         v.suggestions)
                                                                                                                         ,selectedValue: typeof v.selectedValue === "string" || typeof v.selectedValue === "object" && v.selectedValue instanceof String ? v.selectedValue : _U.badPort("a string",
                                                                                                                         v.selectedValue)} : _U.badPort("an object with fields `value`, `placeholder`, `suggestions`, `selectedValue`",
      v);
   });
   var update = F2(function (action,model) {
      ...
      {case "NoOp": return model;
         case "UpdateModel": return _p0._0;
         case "UpdateValue": return _U.update(model,{value: _p0._0});
         default: var _p1 = _p0._0;
           return _U.update(model,{selectedValue: _p1,value: _p1,suggestions: _U.list([])});}
   });
   var UpdateSelect = function (a) {    return {ctor: "UpdateSelect",_0: a};};
   var resultList = F2(function (address,value) {
      return A2($Html.li,_U.list([A2($Html$Events.onClick,address,UpdateSelect(value))]),_U.list([$Html.text(value)]));
   });
   var UpdateValue = function (a) {    return {ctor: "UpdateValue",_0: a};};
   var view = F2(function (address,model) {
      var elems = A2($List.map,resultList(address),model.suggestions);
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.input,
              _U.list([$Html$Attributes.id("search-input")
                      ,$Html$Attributes.placeholder(model.placeholder)
                      ,$Html$Attributes.autofocus(true)
                      ,$Html$Attributes.value(model.value)
                      ,$Html$Attributes.name("search")
                      ,A3($Html$Events.on,"input",$Html$Events.targetValue,function (_p2) {    return A2($Signal.message,address,UpdateValue(_p2));})]),
              _U.list([]))
              ,A2($Html.ul,_U.list([$Html$Attributes.$class("search-results")]),elems)]));
   });
   var UpdateModel = function (a) {    return {ctor: "UpdateModel",_0: a};};
   var NoOp = {ctor: "NoOp"};
   var inbox = $Signal.mailbox(NoOp);
   var actions = A2($Signal.merge,inbox.signal,A2($Signal.map,UpdateModel,item));
   var initialModel = {value: "",placeholder: "",suggestions: _U.list([]),selectedValue: ""};
   ...
   function (v) {
      return {value: v.value
             ...
             ,suggestions: Elm.Native.List.make(_elm).toArray(v.suggestions).map(function (v) {    return v;})
             ,selectedValue: v.selectedValue};
   },
   model);
   var main = A2($Signal.map,view(inbox.address),model);
   var Model = F4(function (a,b,c,d) {    return {value: a,placeholder: b,suggestions: c,selectedValue: d};});
